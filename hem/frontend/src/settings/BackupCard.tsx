...
// server's /api/config/export (the exact on-disk hem-config.json document, so
...
export function BackupCard({
  ...
  const onFile = async (file: File) => {
    ...
    if (doc === null) {
      setErrors([`${file.name} does not look like a HEM settings file.`]);
      return;
    }
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              settings are kept on disk as hem-config.json.bak.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
